  ...
  return (
    <main className="flex flex-col items-center justify-center">
      <div className="flex flex-row max-[1024px]:flex-col items-center justify-center m-14 max-[768px]:m-20">
        ...
        {
           !isImageLoaded ? <Skeleton className="h-[400px] max-[768px]:h-[200px] w-[400px] max-[768px]:w-[200px] rounded-full m-14"/> : null
        }
        <LazyLoadImage beforeLoad={handleSetImageLoaded} src="images/pizza.png" alt="pizza_image" width={isImageLoaded ? 700 : 0}/>
      </div>
    </main>
  );
}
