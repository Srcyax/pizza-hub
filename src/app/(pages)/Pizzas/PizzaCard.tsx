                  ...
                  <Popover open={openDelivery} onOpenChange={setOpenDelivery}>
                    <PopoverTrigger asChild>
                      ...
                      >
                        {valueDelivery
                          ? delivery.find(
                              (delivery) => delivery.value === valueDelivery
                            )?.label
                          : "Selecione"}
                          ...
                          {delivery.map((delivery) => (
                            <CommandItem
                              ...
                              onSelect={(currentValue) => {
                                setDeliveryMethod(currentValue);
                                setValueDelivery(
                                  currentValue === valueDelivery
                                    ? ""
                                    : currentValue
                                );
                  ...
                  <Popover open={openPayment} onOpenChange={setOpenPayment}>
                    <PopoverTrigger asChild>
                      ...
                      >
                        {valuePayment
                          ? payments.find(
                              (payments) => payments.value === valuePayment
                            )?.label
                          : "Selecione"}
                        <ChevronsUpDown className="ml-2 h-4 w-4 shrink-0 opacity-50" />
                      </Button>
            ...
            <AlertDialogAction
              onClick={() => {
                ...
                if (deliveryMethod === "") {
                  toast("Erro!", {
                    description:
                      "Por favor selecione corretamente o Método de entrega.",
                    action: {
                      label: "Ok",
                      onClick: () => console.log("Undo"),
                    },
