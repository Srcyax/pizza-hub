...
export default function PizzaCardInfo({
	...
	return (
		<AlertDialog>
			<AlertDialogTrigger className="border-2 hover:border-orange-500 rounded-lg flex flex-col items-center w-72 transition-colors duration-200">
				{!isImageLoaded ? (
				...
				<p className="text-green-400 text-[17px]">R$49,90</p>
				<p className="text-zinc-400 text-[11px]">40 minutos</p>
				<div className="w-72 text-center">
					<p className="text-center text-zinc-300 m-5">{pizzaDesc}</p>
				</div>
			</AlertDialogTrigger>
			<AlertDialogContent>
				<AlertDialogHeader>
				...
				<AlertDialogFooter>
					...
					<AlertDialogAction
						onClick={() => {
							if (paymentMethod === "") {
								toast("Erro!", {
									description: "Por favor selecione corretamente o Método de pagamento.",
									action: {
										label: "Ok",
